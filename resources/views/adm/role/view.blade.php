                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" placeholder="Vd: Admin, nhân viên...." name="name" value="{{isset($info['name']) ? $info['name'] : old('name')}}" disabled>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control" name="note" disabled>{{isset($info['note']) ? $info['note'] : old('note')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="control-label text-right col-md-3">Các chức năng:</label>
                                        <div class="col-md-9">
                                            <div class="m-b-10">
                                                @foreach($permissions as $key => $item)
                                                    <label class="custom-control custom-radio">
                                                        <input value="{{$item->id}}" id="radio{{$item->id}}" name="permission_id[]" type="checkbox" disabled
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            ...
                                            <a href="{{route('admin.role.edit',$info->id)}}" class="btn btn-danger">Sửa</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6"></div>
